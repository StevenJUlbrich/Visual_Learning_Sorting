...
## 6. Phase 3: The Placement Contract (T2 Tick)
...
* **Resolution:** The key lands perfectly in the empty gap at the baseline. The "KEY" label vanishes. The sprite retains its orange color briefly, transitioning to Green at the start of the next outer pass.

## 7. Z-Ordering Guarantee
...
## 8. Worked Example (`[4, 7, 2, 6, 1, 5, 3]`, pass `i=2`)

*Array before this pass: `[4, 7, 2, ...]` (4 and 7 are already sorted)*
