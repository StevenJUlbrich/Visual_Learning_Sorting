"""Controller / Orchestrator — Phase 6a: pure-data foundation.

This module is built in sub-phases:
  6a — PanelState enum, duration constants, PanelContext container, get_duration()
  6b — update(dt) core loop, tick dispatch
  6c — play/pause/step/restart, elapsed time tracking
  6d — sprite identity delta, highlight dispatch
